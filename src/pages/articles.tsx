...
const articles = [
  ...
  },
  {
    ...
    description: 'Creemos en cómo los creyentes son hechos justos, renacidos espiritualmente y adoptados en la familia de Dios.',
...
const Articles: React.FC<PageProps> = () => {
  return (
        ...
        <ArticlesList>
          {articles.map(article => (
            <ArticleItem
              ...
              Icon={<img alt={article.image.replace('/images/', '').replace('1.webp', '')} style={{ objectFit: 'contain' }} src={article.image} />}
            />
          ))}
        </ArticlesList>
      </Section>
